<template>
  <q-card flat class="card-bg last-card-info">
    ...
    <q-card-section v-if="transductor.name && realTimeMeasurements.length === 0" class="q-pt-xs">
      <h6 class="text-center" style="color: rgba(255, 255, 255, 0.6)">Última medida não disponível</h6>
    </q-card-section>
  </q-card>
</template>
